...
contract SrvExchange_1 {
	...
	*/
    ...
    struct Account {
        ...
        uint256 balance; // balance to record time currency
        uint256 status; // current status: 0-Initialized; 1-active; 2-inactive
    }
	...
	*/
    struct SrvDealer {
        uint256 uid; // auto incremental number.
        uint256 balance; // balance to record time currency for payment
    }
	...
	*/
    function getAccount(address addr_node)
        public
        constant
        returns (
            uint256,
	...
	*/
    function updateProvider(address addr_node, string serviceInfo)
        public
        returns (bool)
    {
	...
	*/
    function updateRecipient(address addr_node, string serviceInfo)
        public
        returns (bool)
    {
	...
	*/
    function recipient_deposit(address addr_node, uint256 time_currency)
        public
        returns (bool)
    {
