...
class SrvExchangeToken(object):
    ...
    def Show_ContractInfo(self):
        ...
        logger.info(self.web3.fromWei(self.web3.eth.getBalance(
            self.web3.eth.accounts[0]), 'ether'))
    ...
    def getAccount(self, account_addr):
        ...
        # get token status
        account_info = self.contract.call(
            {'from': self.web3.eth.coinbase}).getAccount(checksumAddr)
        return(account_info)
    ...
    def initAccount(self, account_addr):
        ...
        ret = self.contract.transact(
            {'from': self.web3.eth.coinbase}).initAccount(checksumAddr)
    ...
    def getService(self):
        ...
        service_list = self.contract.call(
            {'from': self.web3.eth.coinbase}).getService()
        return(service_list)
    ...
    def initService(self):
        ...
        # get service data: dealer, provider and recipient
        ret = self.contract.transact(
            {'from': self.web3.eth.coinbase}).initService()
    ...
    def recipient_withdraw(self, account_addr):
        ...
        # Execute the specified function by sending a new public transaction
        ret = self.contract.transact(
            {'from': self.web3.eth.coinbase}).recipient_withdraw(checksumAddr)
    ...
    def provider_confirm(self, account_addr):
        ...
        # Execute the specified function by sending a new public transaction
        ret = self.contract.transact(
            {'from': self.web3.eth.coinbase}).provider_confirm(checksumAddr)
    ...
    def service_commit(self, account_addr):
        ...
        # Execute the specified function by sending a new public transaction
        ret = self.contract.transact(
            {'from': self.web3.eth.coinbase}).service_commit(checksumAddr)
    ...
    def service_payment(self, account_addr):
        ...
        # Execute the specified function by sending a new public transaction
        ret = self.contract.transact(
            {'from': self.web3.eth.coinbase}).service_payment(checksumAddr)
...
if __name__ == "__main__":
    ...
    mySrvExchange = SrvExchangeToken(
        http_provider, contract_addr, contract_config)
